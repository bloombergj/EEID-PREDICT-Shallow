...
ok there are some people on the internet doing dereplication before learn errors. This seems to be necessary, because when I went straight to learnErrors, I got the error: 
    Error in derepFastq(fls[[i]], qualityType = qualityType) : 
      Not all provided files exist.
In this issue, someone did derepFastq before learnError. I'll see if it works for me, even though this person has an active question too. https://github.com/benjjneb/dada2/issues/1892
